    ...
    const tools = [
      {
        ...
        pro: true,
        cb: "window.MockTest._state=null;window.CF.openMockTest()"
      },
      {
        id: 'analytics',
        icon: '📊',
      ...
      },
      {
        ...
        pro: false,
        cb: "window.CF.openScorePredictor()"
      },
    ];
